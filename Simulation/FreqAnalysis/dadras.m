...
%% Dadras system
function trajectory = dadras_attractor(start_point, end_time, p, o, r, c, e)
...
start_point = [1; 1; 0]; % Initial conditions
end_time = 3000; % End time for the simulation
p = 3;
o = 2.7;
r = 1.7;
c = 2;
...
trajectory = dadras_attractor(start_point, end_time, p, o, r, c, e);
...
figure;
plot3(trajectory.states(1:500,1), trajectory.states(1:500,2), trajectory.states(1:500, 3));
xlabel('X-axis');
ylabel('Y-axis');
zlabel('Z-axis');
title('Dadras Attractor Trajectory');
grid on;
